...
const data = [
  ...
  { name: "Color Pallet", icon: <ColorLensRounded />, url: "/colorpallet", title: 'Adjust menu color pallet' },
  { name: "QR Code", icon: <QrCode2Rounded />, url: "/qrcode", title: 'QR Code' },
  { name: "Analytics", icon: <EqualizerRoundedIcon />, url: "/analytics", title: 'View analytics' },
  { name: "Offers", icon: <LocalOfferRounded />, url: "/offers", title: 'Create and edit offers' },
  { name: "Media", icon: <PermMediaRounded />, url: "/media", title: 'View all photos' },
