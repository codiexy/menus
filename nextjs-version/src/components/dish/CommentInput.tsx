...
import { Tooltip, Avatar, CircularProgress, capitalize, TextField, Button } from '@mui/material';
        ...
        >
            ...
            <div className='comment-wrap-box'>
                <div className='commet-profile'>
                    <Avatar sx={{ width: size, height: size }}>
                        <Image src={user?.photoURL ? user.photoURL : "/user-avatar.png"} alt="User Profile Pic" height={size} width={size} />
                    </Avatar>
                </div>
            ...
            <div className='comment-cancle'>
                ...
                <div className='right-comment'>
                    {
                        isLoading === "submit" ? (
                            <Button className='comment-btn' disabled>Loading...</Button>
                        ) : (
                            <>
                                <Button
                                    sx={{
