      ...
      <Box sx={{ maxWidth: '100%', mt: 5, }}>
        ...
        >
          <Grid item xs={12} md={6} lg={4} >
            <Item elevation={6} sx={{ minHeight: 100 }}><StarBorderOutlined color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Item elevation={6} sx={{ minHeight: 100 }} ><EmojiEmotionsOutlined color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Item elevation={6} sx={{ minHeight: 100 }}  > <AddCommentOutlined color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Item elevation={6} sx={{ minHeight: 100 }} ><QrCode2Outlined color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Item elevation={6} sx={{ minHeight: 100 }} ><SupportAgentOutlined color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Item elevation={6} sx={{ minHeight: 100 }} ><EqualizerRounded color='primary' sx={{ fontSize: '35px' }} />
              <Typography
                variant="h5"
                color='text.primary'
                sx={{
