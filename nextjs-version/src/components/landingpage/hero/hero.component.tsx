      ...
      <Grid container>
        <Grid
          ...
          sx={{
            ...
            backgroundImage: { xs: "none", sm: `url(/assets/image-hero-portrait@2x.webp)` },
        ...
        >
          <div className="hero-svg">
            <Image src={"/assets/pattern-curved-line-1.svg"} width={400} height={200} alt="curve_svg" />
          </div>
          ...
          <div className="hero-p">
            <Typography variant="subtitle1" color='text.primary' sx={{ textAlign: { xs: 'center', sm: 'left', md: 'left' }, maxWidth: { xs: 460, sm: 325 }, pl: { xs: 3, sm: 0 }, pr: { xs: 3, sm: 0 } }}>
              Diners are searching for photos of dishes you serve. Getting in front of diners is half the battle. And with Menuverse, your restaurant&lsquo;s menu will standout from the rest.
            </Typography>
          </div>
          <Box
        ...
        >I
          <CardMedia component="img" image={"/assets/image-hero-landscape@2x.webp"} alt="hero phone" />
        </Grid>
        <Grid
          rowSpacing={4}
          item
