...
import { Tooltip, Avatar, CircularProgress, capitalize } from '@mui/material';
...
export default function CommentInput({ comment, handleSubmit, count, handleOuterCancel, type = "comment" }) {
    ...
    return (
        ...
        >
            ...
            <div className='comment-wrap-box'>
                ...
                <InputBase
                    sx={{ ml: 1, flex: 1 }}
                    placeholder={type === "comment" ? 'Add a comment...' : ""}
